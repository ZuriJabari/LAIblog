...
const BlogPost = ({
  ...
  }, blog.title.text), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, prismic_reactjs__WEBPACK_IMPORTED_MODULE_1__.RichText.render(blog.content.raw)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: "text-sm text-gray-500"
  }, "By ", blog.author ? blog.author.text : 'Unknown', " on ", blog.date), blog.cover_image.url && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", {
    src: blog.cover_image.url,
    alt: blog.title.text,
    className: "w-full h-auto mt-4"
  }));
};
const query = "4189222995";
