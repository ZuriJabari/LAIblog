...
const BlogPage = ({
  ...
  var _blog$categories, _blog$categories$, _blog$featured_image, _blog$multimedia, _blog$quotes, _blog$tags;
  ...
  const plainTextContent = prismic_reactjs__WEBPACK_IMPORTED_MODULE_1__.RichText.asText(blog.content.raw); // Convert RichText to plain text
  ...
  }, prismic_reactjs__WEBPACK_IMPORTED_MODULE_1__.RichText.asText(blog.introduction.raw)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: "text-base text-gray-400 mb-6"
  }, blog.excerpt), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
  ...
  }, prismic_reactjs__WEBPACK_IMPORTED_MODULE_1__.RichText.render(blog.content.raw)), (_blog$multimedia = blog.multimedia) === null || _blog$multimedia === void 0 ? void 0 : _blog$multimedia.map((media, index) => {
