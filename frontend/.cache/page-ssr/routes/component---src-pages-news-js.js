...
/* harmony import */ var _assets_images_news_hero_jpg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../assets/images/news-hero.jpg */ "./src/assets/images/news-hero.jpg");
...
const NewsComponent = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_1__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", {
    ...
    style: {
      backgroundImage: `url(${_assets_images_news_hero_jpg__WEBPACK_IMPORTED_MODULE_3__["default"]})`
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
  ...
  }, "Latest Updates from the Institute"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: "text-lg sm:text-xl text-white max-w-3xl leading-relaxed"
  }, "Explore recent news, announcements, and key developments from the Institute. Stay informed about our progress and impactful initiatives.")))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "prefooter-gray"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "container mx-auto px-6 lg:px-20 py-10"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", {
    className: "text-3xl font-bold text-gray-800 mb-6"
  }, "Featured News"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "grid grid-cols-1 lg:grid-cols-2 gap-6 mb-12"
  }, featuredNews.map(article => {
    var _article$data$feature, _article$data$categor;
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      key: article.id,
    ...
    }, "Published on ", article.data.publish_date, " by", " ", article.data.author || "Unknown"), ((_article$data$categor = article.data.categories) === null || _article$data$categor === void 0 ? void 0 : _article$data$categor.length) > 0 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "flex flex-wrap gap-2 mb-4"
    }, article.data.categories.map((category, index) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_2__.Link, {
    ...
    className: "text-3xl font-bold text-gray-800 mb-6"
  }, "More News"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6"
  }, otherNews.map(article => {
    var _article$data$feature2, _article$data$categor2;
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      key: article.id,
      className: "bg-white shadow-lg rounded-lg overflow-hidden transition-transform duration-300 hover:scale-105"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_2__.Link, {
      to: `/blog/${article.uid}`
    }, ((_article$data$feature2 = article.data.featured_image) === null || _article$data$feature2 === void 0 ? void 0 : _article$data$feature2.url) && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", {
      src: article.data.featured_image.url,
      alt: article.data.title,
      ...
      className: "text-sm text-gray-500 mb-2"
    }, "Published on ", article.data.publish_date, " by", " ", article.data.author || "Unknown"), ((_article$data$categor2 = article.data.categories) === null || _article$data$categor2 === void 0 ? void 0 : _article$data$categor2.length) > 0 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "flex flex-wrap gap-2 mb-4"
    }, article.data.categories.map((category, index) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_2__.Link, {
      to: `/${category.category.toLowerCase()}`,
      key: index,
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("/static/news-hero-0486d914bd0d96c5b81799a6c340f189.jpg");
